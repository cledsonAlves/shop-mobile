...
class _$ProductEntityImpl implements _ProductEntity {
  ...
  @override
  String toString() {
    return 'ProductEntity(id: $id, name: $name, description: $description, price: $price, imageUrl: $imageUrl, storeId: $storeId, storeName: $storeName, category: $category, stock: $stock, rating: $rating, reviewCount: $reviewCount)';
  }
...
abstract class _ProductEntity implements ProductEntity {
  const factory _ProductEntity(
      ...
      final int stock,
      final double rating,
      final int reviewCount}) = _$ProductEntityImpl;
