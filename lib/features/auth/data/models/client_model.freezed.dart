...
class _$ClientModelImpl extends _ClientModel {
  ...
  @override
  String toString() {
    return 'ClientModel(id: $id, nome: $nome, email: $email, cpf: $cpf, telefone: $telefone, endereco: $endereco, cidade: $cidade, estado: $estado, cep: $cep, ativo: $ativo, criadoEm: $criadoEm, atualizadoEm: $atualizadoEm)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, nome, email, cpf, telefone,
      endereco, cidade, estado, cep, ativo, criadoEm, atualizadoEm);
